...
# --- Patch 8: Inject mega_batch_eval for batched scoring (4-10x faster) ---
...
if _fn_match:
    ...
    # Indent for injection inside the main() function
...
print('[EvoEdit] evaluate.py patched: model resolve, results dir, dataset override, checkpoints, mega-batch eval')
